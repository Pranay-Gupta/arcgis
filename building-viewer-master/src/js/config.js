define(["require", "exports", "tslib", "esri/widgets/support/widget", "./sections/HomeSection", "./sections/FloorsSection", "./sections/SurroundingsSection"], function (require, exports, tslib_1, widget_1, HomeSection_1, FloorsSection_1, SurroundingsSection_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.extraQuery = exports.floorMapping = exports.sections = exports.websceneId = exports.portalUrl = void 0;
    HomeSection_1 = tslib_1.__importDefault(HomeSection_1);
    SurroundingsSection_1 = tslib_1.__importDefault(SurroundingsSection_1);
    // import Collection from "esri/core/Collection";
    // import {Timetable, DayTimetable} from "./widgets/Timetable/Timetable";
    exports.portalUrl = "https://pinnacleinfotech.maps.arcgis.com/";
    exports.websceneId = "0b7e49b146c54407bb041a0d7303d5d0";
    exports.sections = [
        new HomeSection_1.default({
            content: function (that) { return ((0, widget_1.tsx)("p", null, "T\u016Branga is a library in Central Christchurch and the main library of Christchurch City Libraries, New Zealand. It is the largest library in the South Island and the third-biggest in New Zealand. The previous Christchurch Central Library opened in 1982 on the corner of Oxford Terrace and Gloucester Street but was closed after the February 2011 Christchurch earthquake and demolished in 2014 to make way for the Convention Centre Precinct.")); },
        }),
        new FloorsSection_1.FloorsSection({
            minFloor: 0,
            maxFloor: 2
        }),
        new SurroundingsSection_1.default({})
    ];
    ...
    // ];
    var floorMapping = function (originalFloor) {
        var floor = originalFloor + 1;
        if (floor >= 3) {
            floor += 1;
        }
        return floor;
    };
    exports.floorMapping = floorMapping;
    exports.extraQuery = " AND (Category <> 'Generic Models' OR OBJECTID_1 = 2) AND Category <> 'Walls' AND Category <> 'Roofs'  AND Category <> 'Curtain Wall Mullions' AND Category <> 'Curtain Panels'";
});
